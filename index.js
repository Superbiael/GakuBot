   ...
   bot.on("message", async message => {
    ...
    if(msg.startsWith (prefix + "quote")) {
        ...
        switch (random) {
          ...
          case 22: message.channel.send ("If I'm gonna be a man, then I want to be a cool man. As ambitious as this sounds I want to be able to protect not only TRIGGER or IDOLiSH7, but Re:vale, too."); break;
          case 23: message.channel.send ("I want to eat noodles when they're at their best.\nThat's why I want to cook them right down to the exact second. The real battle begins when the kitchen timer rings.\nI immediately have to power out the boiling water, add the broth, and finish it up with toppings. Even a couple of extra hands aren't enough to do that."); break;
